...
fig.suptitle('SLP',fontsize=13,fontweight="bold",y=0.992)
    ...
    for timestep in np.arange(0,8,2): #plotting 3,12,21Z timesteps
       ...
       #add sublabels to single plots
        ...
        ax.text(0.0, 1.0, sublabel[i], transform=ax.transAxes + sublabel_loc,
            ...
            bbox=dict(facecolor='1', edgecolor='none', alpha=0.85, pad=1.5))
...
cbar.set_label('hPa',fontsize=9.5,labelpad=-0.5, fontweight='bold')

#SHOW MAP
save_dir='I:\\Emma\\LaborDayWildfires\\Figures\\1FinalFigures'
os.chdir(save_dir)
plt.savefig('F4_SLP_rev.png',dpi=300)
plt.show()